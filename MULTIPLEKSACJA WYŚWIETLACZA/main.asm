...
.macro seg7
 ...
 rjmp setdisplay   ; and go back and check next number
  ...
  out portD,temp   ; set portB pins (xtal pins don't matter)
  andi temp,0b11000000 ; bitwise AND to set PD7,PD6
  out portA,temp  ; set portD pins
.endmacro
...
;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  ser temp
  out DDRD,temp          ; set PortB to output
  ldi temp, 0b11111110
...
main:
  ...
  seg7 segnumber    ; display 7segnumber value
...
ADC_int:
 ...
 setkey:
  ...
  lpm segnumber,Z      ; otherwise load keyvalue table
